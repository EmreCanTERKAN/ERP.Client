...
export class RecipeDetailsComponent {
  ...
  getRecipeById(){
    this.http.post<RecipeModel>("recipeDetail/getByIdRecipeWithDetails ",{recipeId: this.recipeId},(res)=> {
      this.recipe = res;
    });
  }
  ...
  deleteById(model: RecipeDetailModel){
    this.swal.callSwal("Reçetedeki Ürünü Sil?",`${model.product.name} ürününü silmek istiyor musunuz?`,()=> {
      this.http.post<string>("recipeDetail/deleteById",{id: model.id},(res)=> {
        this.getRecipeById();
